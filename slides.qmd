...
## Linear Regression: Why we fit it first?

1.  **baseline** model -\> established a benchmark model for predicting calorie burn based on exercise & diet predictors
2.  created a reference for variable importance
3.  interpretability & help identying key relationships
4.  sanity check that the modeled relationships behaved as expected

## Linear Regression Methods

1.  Fit multiple linear regression models for diet, exercise, and diet & exercise combined
2.  Checked assumptions: linearity, homoscedasticity, independence, normality
3.  Evaluated influence/outliers
4.  Assessed variable significance through coefficient tables
5.  Compared the 3 models using $R^2$, adjusted $R^2$, F-tests, & RMSE
6.  Visualized relationships via scatterplots, residual plots, & effects plots
