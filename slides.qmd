...
1.  **baseline** model -\> established a benchmark model for predicting calorie burn based on exercise & diet
2.  created a reference for variable importance
3.  sanity check that the modeled relationships behaved as expected
