...
graph_width <- 6.5
graph_height <- 4
ggsave("graphs/Images for paper/final_predval_rf.png", pred_val_RF, width = graph_width, height = graph_height)
```
