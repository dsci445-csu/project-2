...
NFC_prop <- ggplot(NFC, aes(x = team_num, y = n_play, fill = type)) +
  ...
  scale_fill_manual(values = c("full_n_pass" = "lightblue", "full_n_run" = "red"),
                 labels = c("Pass", "Run")) +
  # scale_fill_manual(values = c("full_n_run" = "lightblue", "full_n_pass" = "red"),
  #                labels = c("Run", "Pass")) +
  ...
  theme(
    ...
    #legend.title = element_text("Play Type")
  ) +
...
pred_val_RF <- ggplot(data = NFL_rf_results, aes(x = full_ru_ppv, y = full_pa_npv)) +
  ...
  labs(title = "Prediction Confidence for NFL Offenses - Run or Pass",
...
graph_width <- 12
graph_height <- 5
ggsave("graphs/NFC_prop.png", NFC_prop , width = graph_width, height = graph_height)
```
