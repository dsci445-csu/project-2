...
the SVM model performed quite well at predicting run or pass. We tried
to see if there were any trends in the predictability based on win
percentage or conference. However these plots did not show any trends
indicating even further that teams are quite unique when it comes to
their tendencies.
