...
```
  ...
  There were also several models with MCC scores of $\approx 0$. These teams include the Indianapolis Colts, Los Angeles Rams, Pittsburgh Steelers, and the San Francisco 49'ers. The MCC score for these models indicate that their predictions for run or pass were no better than random guessing. This
