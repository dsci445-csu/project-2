...
## 6. Model Evaluation:
  ...
  To evaluate our models performance we decided to employ Matthews Correlation Coefficient (MCC). MCC which can be understood as the correlation coefficient between predicted and actuall classifications can be expressed mathematically as follows:
